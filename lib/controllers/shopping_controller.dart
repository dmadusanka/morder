...
class ShoppingController extends GetxController{
  ...
  void fetchingProduct() async{
    ...
    var productRespons = [
      Product(1,"chocolate biscuit",30.0,"Some description goes here","asd"),
      ...
      Product(3,"Butter Scotch biscuit",59.8,"Some description goes here","asd"),
      Product(3,"Suger Free biscuit",13.4,"Some description goes here","asd"),
